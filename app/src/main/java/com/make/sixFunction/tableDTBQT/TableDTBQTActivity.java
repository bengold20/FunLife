package com.make.sixFunction.tableDTBQT;
...
//            Log.e( "showAllContacts: te", tableDTBQT +"" );

            listTableDTBQTModel.add(tableDTBQTModel);
//            Log.e( "showAllContacts: te1", listTableDTBQT +"" );
        }
        cursor.close();

        adapterTableDTBQT.setData(listTableDTBQTModel);

//        Log.e( "showAllContacts: te2", listTableDTBQT +"" );
